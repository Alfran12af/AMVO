...
%
% Inputs:
%   u_expr : symbolic expression of horizontal velocity
%   v_expr : symbolic expression of vertical velocity
%   N      : number of cells
%   xu,yu  : coordinates where u is defined
%   xv,yv  : coordinates where v is defined
%
% Outputs:
%   conv_u : analytical convective term for u
%   conv_v : analytical convective term for v
%   diff_u : analytical diffusive term for u
%   diff_v : analytical diffusive term for v
